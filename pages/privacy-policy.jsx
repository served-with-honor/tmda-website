		...
		<Page title={'Privacy Policy'}>
			...
			<Box sx={{ m: 10 }}>
				<Container>
					...
					<Typography variant='body1'>If you are looking for assistance on a medical service that you have submitted, and need to locate our ticket portal - <Link href={siteSettings.externalLinks.helpDesk} target="_blank">please click here</Link>.</Typography>
				</Container>
			</Box>
  	</Page>
  )
