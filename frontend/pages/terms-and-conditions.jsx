		...
		<Page title={'Terms and Conditions'}>
			...
			<Box sx={{ my: 10 }}>
				<Container>
					...
					<Typography variant='body1' gutterBottom>For mental health appointments, you understand that you will be matched with a provider licensed in the state you choose upon booking. You need to be physically located in the state at the time of the appointment otherwise, you will be charged a $50 rescheduling fee.</Typography>
					<Typography variant='body1' gutterBottom>Telemedica charges and collects a portion OR all the fee in advance for the use of all Telemedica Services. Fees for other services will be charged on an as-quoted basis and billed to you directly or charged to your card on file. Telemedica's prices are exclusive of all taxes or duties imposed by taxing authorities, and you shall be responsible for payment of all such taxes or duties.</Typography>
					...
					<List component='ol' marker='decimal' sx={{ mb: 3 }}>
						<ListItem variant='body1' gutterBottom>Mental Health Evaluation<sup>*/****</sup>&nbsp;- $1,495</ListItem>
						...
						<ListItem variant='body1' gutterBottom>Telemedicine Medical Diagnosis Evaluation<sup>*/****</sup>&nbsp;- $985</ListItem>
						<ListItem variant='body1' gutterBottom>Additional Telemedicine Medical Diagnosis Evaluation - $860</ListItem>
						<ListItem variant='body1' gutterBottom>Medical Nexus Records Review (up to 500 pages)<sup>*</sup>&nbsp;- $299</ListItem>
						<ListItem variant='body1' gutterBottom>Additional Pages For Records Review (500 pages) - $99</ListItem>
						<ListItem variant='body1' gutterBottom>Unlimited Pages & Medical Records Review for 90 days<sup>*</sup>&nbsp;- $99</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Letter (1 connection)<sup>*/*</sup>&nbsp;- $1,345</ListItem>
						<ListItem variant='body1' gutterBottom>P&T Document/Specialty Letter<sup>*/*</sup>&nbsp;- $1,345</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Letter Enhanced (2+ connections)<sup>*/*</sup>&nbsp;- $1,595</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Service DBQ (1-4 pages)<sup>*/**</sup>&nbsp;- $1,145</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Service DBQ Enhanced (4+ pages)<sup>*/**</sup>&nbsp;- $1,400</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Service Rebuttal Letter<sup>*/**</sup>&nbsp;- $275</ListItem>
						...
						<ListItem variant='body1' gutterBottom>* For Mental Health Evaluation, there is a $125 Non-Refundable Technology & Access Fee. There is an additional $54 Non-Refundable Chart Review Fee. This is obtained when services are initiated.</ListItem>
						<ListItem variant='body1' gutterBottom>* For Telemedicine Evaluation, there is a $125 Non-Refundable Technology & Access Fee. There is an additional $54 Non-Refundable Chart Review Fee. This is obtained when services are initiated.</ListItem>
						<ListItem variant='body1' gutterBottom>* For Nexus Letter/DBQ Services, there is a $299 ($398 for unlimited chart review) Non-Refundable Technology & Access Fee. This is obtained when services are initiated.</ListItem>
						<ListItem variant='body1' gutterBottom>** Chart review must be completed prior to service</ListItem>
						<ListItem variant='body1' gutterBottom>*** In some cases, a targeted chart review must be completed before confirmation that this document is possible with a cost of $50</ListItem>
						<ListItem variant='body1' gutterBottom>**** This fee includes a medical chart review of up to 500 pages. Additional fees apply if uploading more than 500 pages. See fee breakdown for chart review pages</ListItem>
					...
					<List component='ol' marker='decimal' sx={{ mb: 3 }}>
						<ListItem variant='body1' gutterBottom>Mental Health Evaluation<sup>*/****</sup>&nbsp;- $599</ListItem>
						<ListItem variant='body1' gutterBottom>Psych Re-evaluation - $150</ListItem>
						<ListItem variant='body1' gutterBottom>Psych Rebuttal Letter - $200</ListItem>
						<ListItem variant='body1' gutterBottom>Telemedicine Medical Diagnosis Evaluation<sup>*/****</sup>&nbsp;- $524</ListItem>
						<ListItem variant='body1' gutterBottom>Additional Telemedicine Medical Evaluation - $399</ListItem>
						<ListItem variant='body1' gutterBottom>Medical Nexus Records Review (up to 500 pages)<sup>*</sup>&nbsp;- $299</ListItem>
						<ListItem variant='body1' gutterBottom>Additional Pages For Records Review (500 pages) - $99</ListItem>
						<ListItem variant='body1' gutterBottom>Unlimited Pages & Medical Records Review for 90 days<sup>*</sup>&nbsp;- $99</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Letter<sup>*/*</sup>&nbsp;- $520</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Letter Enhanced/Specialty Letter/P&T Document<sup>*/*</sup>&nbsp;- $620</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Service DBQ (1-4 pages)<sup>*/*</sup>&nbsp;- $325</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Service DBQ Enhanced (4+ pages)<sup>*/**</sup>&nbsp;- $425</ListItem>
						<ListItem variant='body1' gutterBottom>Nexus Service Rebuttal Letter<sup>*/**</sup>&nbsp;- $275</ListItem>
						<ListItem variant='body1' gutterBottom><strong><sup>*</sup>This fee is made up of two separate charges: (i) a portion is retained for the Professional Fee charged by the Independent Provider’s PLLC, and (ii) a portion is retained for an Administrative Management Fee charged by Telemedica LLC.</strong></ListItem>
						...
						<ListItem variant='body1' gutterBottom>** Chart review must be completed prior to service.</ListItem>
						<ListItem variant='body1' gutterBottom>*** In some cases, a targeted chart review must be completed before confirmation that this document is possible with a cost of $50.</ListItem>
						<ListItem variant='body1' gutterBottom>**** This fee includes a medical chart review up to 500 pages. Additional fees apply if uploading more than 500 pages. See fee breakdown for chart review pages.</ListItem>
					</List>
