...
export default [
  {
    ...
    answer:
      "The link to your evaluation will be sent via text and email shortly before your scheduled appointment time.",
    topic: "General",
  },
  {
    question: "Do I need to download Zoom before my appointment?",
    answer:
      "No, you are not required to download Zoom or any special application for the appointment.",
    topic: "General",
  },
  {
    question: "Where do I need to go for my appointment?",
    answer:
      "You will be matched with a provider who is licensed in the state you choose, so you need to be physically located in that state at the time of the appointment. You will access your appointment via a link that will be sent to you prior to your appointment.",
    topic: "General",
  },
  {
    question: "Where and how do I upload my documents?",
    answer:
      "Your intake package will walk you through the documents you’ll need to upload in order to proceed with your desired service. Any records you’d like to add after you’ve completed your intake package may be uploaded using the paperclip in the bottom left corner of the messaging section of the patient portal. (please note additional fees may apply. See “What is the 90 day plan and do I need it?” for more information.",
    topic: "General",
  },
  {
    question:
      "Why are there no Mental Health Evaluation appointments in my state?",
    answer:
      "Either there is no available provider licensed in your state or we are fully booked.",
    topic: "General",
  },
  {
  ...
  },
  {
    ...
    answer:
      "CS will confirm if veteran is a VACI client first, then will refer to VACI price list.",
    topic: "General",
  },
  {
    question: "When will I receive my document?",
    answer:
      "Within 10 business days from the time your invoice is paid for physical medical conditions and within 10 business days of the completion of your mental health evaluation for Psych. For Nexus, you may also pay a rush fee ($100 per document) to receive them within 2 business days.",
    topic: "General",
  },
  {
  ...
  },
  {
    ...
    answer:
      "This depends on your knowledge of the VA disability claims process and the services offered by Telemedica. You can purchase our Nexus Services using this <a href='/services#booking' style='color: #2F4177'>link</a>. If you aren't certain or would like assistance with discovering which of our services would be best for you, you can use this <a href='/consultation-call' style='color: #2F4177'>link</a> to schedule an appointment with one of our Veteran Ambassadors.",
    topic: "General",
  },
  {
    question:
      "What is the next step after I complete the Nexus Intake Package form?",
    answer:
      "You will be assigned to a Nexus provider. The provider will send your comprehensive chart review and summary document to you in the patient portal within 3 business days. You will also be sent an order form which will allow you to order your Nexus documents.",
    topic: "General",
  },
  {
    question: "What is the $299 fee for?",
    answer:
      "The $299 fee covers the Nexus records review process. With the records review process you’ll receive a comprehensive chart review, summary document and document order form(if applicable). Please note that a medical Nexus letter and/or DBQ is a separate charge and is not included in this cost.",
    topic: "General",
  },
  {
    question: "What is the difference between a regular and enhanced letter?",
    answer:
      "A Nexus letter links one potential service-connected condition to one already service-connected condition. A Nexus letter enhanced links one potential service-connected condition to 2 or more already service-connected conditions.",
    topic: "General",
  },
  {
    question:
      "How do I contact the Nexus provider? Can the Nexus provider call me?",
    answer:
      "All communication with your Nexus provider will take place within the patient portal. If you have questions you’d like to address over the phone, please reach out to our customer service team so that they can assist.",
    topic: "General",
  },
  {
    question:
      "Where will I answer the Nexus provider's comments or questions in my chart review?",
    answer: "You may answer them by sending a message in the portal.",
    topic: "General",
  },
  {
    question:
      "I do not see any invoice included in the chart review, how much is the total for my document/s?",
    answer:
      "You will be able to view the price list under the Payment Terms in your intake form and when you fill out the order form.",
    topic: "General",
  },
  {
    question: "Is the $299 deducted from my total invoice?",
    answer:
      "The $299 fee covers the Nexus records review process only. Medical Nexus letters and/or DBQs are a separate charge.",
    topic: "General",
  },
  {
    question: "What are the qualifications of your providers?",
    answer:
      "Our Nexus providers are comprised of PA-Cs, NPs, or FNP-Cs, while our Psych providers are licensed Psychologists.",
    topic: "General",
  },
  {
  ...
  },
  {
    ...
    answer: `You may book through our <a href='\services#booking' style='color: #2F4177'>booking link</a>  or by phone at <a style="color: #2F4177" href="tel:${
      constants.company.contact.phone
    }">${formatPhoneNumber(
      constants.company.contact.phone
    )}</a>, but if you encounter any issues, feel free to reach out to customer service for assistance.`,
    topic: "General",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A payment of $599 is required to book the appointment. The remaining balance needs to be paid 48 hours prior to the scheduled appointment.",
    topic: "General",
  },
  {
    question: "Will my Mental Health Evaluation be in-person or online?",
    answer:
      "Your evaluation will be conducted online via video call. The link is sent a few minutes before the appointment.",
    topic: "General",
  },
  {
    question: "What is the 3rd party rate?",
    answer:
      "We do offer a discount to veterans that are working with some 3rd party companies. The customer service team can help you determine if you qualify for the 3rd party discount or not.",
    topic: "General",
  },
  {
    question: "What is the 90 day plan and do I need it?",
    answer:
      "The 90 day plan is required if you upload 500 or more pages of records or if you upload additional records for review after the review process has started. It also allows you to upload additional records within the 90 day timeframe without paying any additional review fees. The cost is $99 and the plan does not auto renew.",
    topic: "General",
  },
  {
  ...
  {
    question:
      "This process feels overwhelming. Can I speak with someone to help me understand the service I need?",
    answer:
      "Yes, on our homepage you’ll find a link to book a free 20 minute consultation call with one of our veteran ambassadors. They’ll be able to answer any questions you may have to make the process a little less overwhelming. You can also call customer service at 512-883-8446 to book this service.",
    topic: "General",
  },
  {
    question:
      "I’d like to have my records reviewed for possible physical medical conditions and I’d like to schedule a mental health evaluation. Do I need to sign up for both services?",
    answer:
      "No, the Nexus records review process is included in the cost of your mental health evaluation.",
    topic: "General",
  },
  {
    question:
      "What is an Independent Medical Opinion (IMO) from Telemedica, and why should I get one?",
    answer:
  ...
  {
    question:
      "I feel nervous or uncomfortable about my upcoming evaluation. What can I do to prepare?",
  ...
  },
  {
    ...
    answer:
      "Mental health disorders and life circumstances can change quite rapidly. Because of this, we cannot edit or make changes to any IMO over six months old. It is recommended that if you would like changes made you make an appointment for a new evaluation.",
    topic: "Psych",
  },
  {
    question:
      "I have a friend who has the exact same symptoms as I do, but my psychologist gave me a different diagnosis. Why did this happen?",
    answer:
      "Many mental health diagnoses have overlapping symptoms. Symptoms can show up in one person in different ways, and, although you and your friend may have similar symptoms, only someone with schooling and training can determine your true diagnosis.",
    topic: "Psych",
  },
  {
    question:
      "I read the symptoms for the diagnosis I think I have online. Why didn’t my psychologist agree?",
  ...
  {
    question:
      "I have hired another company to help me obtain my disability benefits. Someone at this company said that I have a certain diagnosis, but my psychologist disagreed. What happened?",
  ...
  },
  {
    ...
    answer:
      "We can only complete DBQs for conditions in which we do not need to perform an in-person physical examination. Some conditions require this for rating purposes. Examples include orthopedic conditions and most neurological conditions (except headache conditions).",
    topic: "Nexus",
  },
  {
  ...
  {
    question:
      "Can I get a rebuttal document if I did not get the award percentage I wanted?",
    answer:
      "No, we do not guarantee a specific award percentage. There are many factors that go into which award percentage is assigned by the VA, and even though our document may be written to support a higher level than you received, it may have been due to other factors in your claim filing or during the C&P exam. If you think that you qualify for a higher rating, we can evaluate a DBQ as a stand-alone document to ask for an increase in your service-connected condition. To do this, you would sign up for the nexus service for the provider to evaluate your evidence and claim.",
    topic: "Nexus",
  },
  {
    question:
      "My friend got a document from your company for the same connection I am looking for… can I qualify for a nexus? I saw a VA board of appeals case with this connection, can I sign up to get a letter?",
    answer:
      "Each case is evaluated for supporting a service connection. Just because a connection can be made for one Veteran, it does not mean that everyone will qualify for the connection. This is why our trained providers complete a thorough review of the uploaded records before discussing what document(s) you may qualify for.",
    topic: "Nexus",
  },
  {
    question: "How many conditions can I be diagnosed within 1 visit?",
    answer:
      "Our Telehealth providers can diagnose 2 conditions per appointment. Please note that only one condition is included in the cost of the initial appointment. Each additional diagnosis will incur an additional charge.",
    topic: "Telemedicine",
  },
  {
    question: "Is the fee per visit or per diagnosis?",
    answer:
      "The fee is per evaluation document. If you were seen for multiple conditions, our fees are per condition.",
    topic: "Telemedicine",
  },
  {
    question:
      "Can I be seen for a condition that is not listed on your approved condition list?",
    answer:
      "Possibly. If you would like to be seen for a condition that is not listed on our approved list, please reach out to our customer service team for assistance, and they can confirm with the medical team.",
    topic: "Telemedicine",
  },
  {
