...
export default [
	...
	},
	{
		...
		answer: `You may book through our booking link - ${siteSettings.externalLinks.booking} or by phone at ${formatPhoneNumber(siteSettings.contact.phone)}, but if you encounter any issues, feel free to reach out to customer service for assistance.`,
    topic: 'General',
	...
	},
	{
		...
		answer: `If you notice a mistake on your IMO, you should create a ticket in the Telemedica Help Desk. This way your psychologist can respond to you and ensure that any factual corrections are made in a timely manner and that your concerns are reviewed. It is up to the discretion of the independent provider to use their clinical judgement and provide a determination. The Help Desk can be found at: ${siteSettings.externalLinks.helpDesk}.`,
		topic: 'Psych',
	},
	{
